		...
		<div id="Detail">
			...
			<div className="detail-layout">
				<div className="detail-section">
					<div className="view-layout px-0">
						<div className="container mt-1 ft-s-s">
							<h1 className="ft-s mb-3 bottomLine">{item.title}</h1>
							{/* <ul className="work-info">
								<li>Date: {item.date}</li>
								<li>Category: {item.cate}</li>
							...
							<div className="row mt-5 m-auto justify-content-center">
								...
								{ item.movie2 !== "" ? <div className="col-md-6 mb-0 p-0"><div className="detail-video-wrapper"><iframe title={item.title} className="detail-video" width="550" height="350" src={item.movie2+'?autoplay=1&showinfo=0&loop=1&mute=1&rel=0'} frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe></div></div>  : null }
							</div>
							<div className="row mb-4 m-auto justify-content-center">
								...
								{ item.img2 !== "" ? <div className="col-md-6 mb-0 p-0"><img src={item.img2} className="detail-img" alt={item.title}></img></div> : null }
								{ item.img3 !== "" ? <div className="col-md-6 mb-0 p-0"><img src={item.img3} className="detail-img" alt={item.title}></img></div> : null }
								{ item.img4 !== "" ? <div className="col-md-6 mb-0 p-0"><img src={item.img4} className="detail-img" alt={item.title}></img></div> : null }
							</div>
						</div>
					</div>	
				</div>	
