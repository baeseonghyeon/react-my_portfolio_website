					...
					<div className="view-layout">
						<div className="container mt-1 ft-s-s">
							...
							<div className="row mb-4 m-auto justify-content-center">
								{ item.img1 !== "" ? <div className="col-md-6 mb-1 pd-03"><img src={item.img1} className="detail-img" alt={item.title}></img></div> : null }
								{ item.img2 !== "" ? <div className="col-md-6 mb-1 pd-03"><img src={item.img2} className="detail-img" alt={item.title}></img></div> : null }
								{ item.img3 !== "" ? <div className="col-md-6 mb-1 pd-03"><img src={item.img3} className="detail-img" alt={item.title}></img></div> : null }
								{ item.img4 !== "" ? <div className="col-md-6 mb-1 pd-03"><img src={item.img4} className="detail-img" alt={item.title}></img></div> : null }
							</div>
						</div>
					</div>	
				</div>	
