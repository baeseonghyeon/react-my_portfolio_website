...
const workData = [
  {
    ...
    data: [
      ...
      },
      {
        ...
        content: {
          text: '삼육대학교 천보축전 & 체육대회 웹사이트입니다. 삼육대학교 축제(천보축전)와 체육대회의 홍보, 정보게시, 이벤트 진행을 목적으로 개발되었습니다. 메인페이지를 통해 각각 다른 컨셉과 디자인의 축제 웹사이트와 체육대회 웹사이트를 이용할 수 있습니다. 삼육대학교 총학생회와 멋쟁이사자처럼 at 삼육대학교가 협업하여 제작하였습니다. 프로젝트와 웹사이트의 기획과 프론트엔드 개발을 총괄하였습니다. 한 주간 페이뷰 수 37,473을 기록했습니다.'
        },
        links: [
          {
            type: 'github',
      ...
      },
      {
        ...
        content: {
          text: "Developer Student Clubs 삼육대학교 에서 진행한 Github 정원사들('두유 Know 잔디?)이벤트 출석부 웹사이트입니다. GDG 판교의 정원사들 시즌5 출석부의 코드 및 디자인 리팩토링을 통해 개발하였습니다. 두 달간 이벤트 진행을 위해 사용하였습니다.",
          links: [
            {
      ...
      },
      {
        ...
        content: {
          text: '클럽 모임 커뮤니티, 연결 플랫폼 클러버(Clubber)의 앱 클라이언트, 관리자 웹 클라이언트를 외주 개발하였습니다.',
          links: [
            {
              title: 'GooglePlay',
