...
function Popup(props) {
    ...
    const popupPosition = () => {
        ...
        popup.style.left = Math.random() * (((window.innerWidth - popup.offsetWidth) * 0.8)) + (window.innerWidth * 0.1) + "px"
        popup.style.top = Math.random() * (((window.innerHeight- popup.offsetHeight) * 0.7)) + (window.innerHeight * 0.1) + "px"
    }
